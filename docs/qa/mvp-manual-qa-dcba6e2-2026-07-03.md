# MVP Manual QA - dcba6e2 - 2026-07-03
...
- Artifact source: GitHub Actions workflow run `28691766065`
- Artifact name:
...
- [x] CI run `28691766065` completed successfully.
- [x] `npm run qa:current-ci-artifact -- dcba6e204cfd4450b6fd1753ee368ec34ddc58d9` passed.
- [x] `npm run qa:prepare-ci-candidate -- 28691766065 dcba6e204cfd4450b6fd1753ee368ec34ddc58d9` passed.
- [x] `npm run qa:candidate-packet -- 28691766065 dcba6e204cfd4450b6fd1753ee368ec34ddc58d9` passed.
