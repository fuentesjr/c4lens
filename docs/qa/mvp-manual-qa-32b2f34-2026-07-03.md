# MVP Manual QA - 32b2f34 - 2026-07-03
...
- Artifact source: GitHub Actions workflow run `28689213998`
- Artifact name:
...
- [x] CI run `28689213998` completed successfully.
- [x] `npm run qa:current-ci-artifact -- 32b2f348570035db61cb57a6a6cb249cdaff233d` passed.
- [x] `npm run qa:prepare-ci-candidate -- 28689213998 32b2f348570035db61cb57a6a6cb249cdaff233d` passed.
- [x] `npm run qa:candidate-packet -- 28689213998 32b2f348570035db61cb57a6a6cb249cdaff233d` passed.
