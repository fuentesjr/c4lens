# MVP Manual QA - e9ce78b - 2026-07-03
...
- Artifact source: GitHub Actions workflow run `28692429869`
- Artifact name:
...
- [x] CI run `28692429869` completed successfully.
- [x] `npm run qa:current-ci-artifact -- e9ce78be93a79370e80064f94ab91bfbb9a6fff2` passed.
- [x] `npm run qa:prepare-ci-candidate -- 28692429869 e9ce78be93a79370e80064f94ab91bfbb9a6fff2` passed.
- [x] `npm run qa:candidate-packet -- 28692429869 e9ce78be93a79370e80064f94ab91bfbb9a6fff2` passed.
