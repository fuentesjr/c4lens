# MVP Installed GUI QA Handoff - 2026-07-05
...
Artifact expiration: `2026-07-18T03:56:31Z`

Artifact size: 24593645 bytes

Status: ready for human installed-app interaction pass.

## Automated Gate Context

- CI run `28694068981` uploaded the expected macOS universal artifact.
- `npm run qa:current-ci-artifact -- 7e14f0a68a8b94e25087f58c8f9d7ec103f6317d` verifies this run and
  artifact metadata.
- `npm run qa:prepare-ci-candidate -- 28694068981 7e14f0a68a8b94e25087f58c8f9d7ec103f6317d` downloads and
...
in `docs/qa/mvp-manual-qa-7e14f0a-2026-07-05.md`.
