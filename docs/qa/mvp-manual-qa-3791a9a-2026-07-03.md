# MVP Manual QA - 3791a9a - 2026-07-03
...
- Artifact source: GitHub Actions workflow run `28688315327`
- Artifact name:
...
- [x] CI run `28688315327` completed successfully.
- [x] `npm run qa:current-ci-artifact -- 3791a9a75ab1232bab1c61741980ab1ac97ba4de` passed.
- [x] `npm run qa:prepare-ci-candidate -- 28688315327 3791a9a75ab1232bab1c61741980ab1ac97ba4de` passed.
