# MVP Manual QA - 243b8b1 - 2026-07-03
...
- Artifact source: GitHub Actions workflow run `28693651191`
- Artifact name:
...
- [x] CI run `28693651191` completed successfully.
- [x] `npm run qa:current-ci-artifact -- 243b8b13377dc6b505403cec095fef1d7d6bd8a0` passed.
- [x] `npm run qa:prepare-ci-candidate -- 28693651191 243b8b13377dc6b505403cec095fef1d7d6bd8a0` passed.
- [x] `npm run qa:candidate-packet -- 28693651191 243b8b13377dc6b505403cec095fef1d7d6bd8a0` passed.
