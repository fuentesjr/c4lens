...
| Current manual QA result stub | Implemented | `docs/qa/mvp-manual-qa-243b8b1-2026-07-03.md` is prefilled with current candidate metadata and the remaining installed-app GUI checks. |
