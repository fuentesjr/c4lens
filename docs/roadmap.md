...
| Current manual QA result stub | Implemented | `docs/qa/mvp-manual-qa-e9ce78b-2026-07-03.md` is prefilled with current candidate metadata and the remaining installed-app GUI checks. |
